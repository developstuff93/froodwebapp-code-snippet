...
export const PURCHASE_SUPPLIER_LOCATIONS_GET = createRequestTypes('PURCHASE_SUPPLIER_LOCATIONS_GET');
...
// export const PURCHASE_SUPPLIER_PRICE_LIST_GET = createRequestTypes('PURCHASE_SUPPLIER_PRICE_LIST_GET');
...
export const supplierLocationsGetRequest = createRequestFunc(PURCHASE_SUPPLIER_LOCATIONS_GET, 'vendor/{id}/locations');
...
// export const supplierPriceListGetRequest = createRequestFunc(PURCHASE_SUPPLIER_PRICE_LIST_GET, 'vendor/{id}/pricelist');
export const supplierPriceListGetRequest = createParallelRequestFunc(PURCHASE_SUPPLIER_PRICE_LIST_GET_PARALLEL, ['vendor/{id}/pricelist', 'pricelists']);
